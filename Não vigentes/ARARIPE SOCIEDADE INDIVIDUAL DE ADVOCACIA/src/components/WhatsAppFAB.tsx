...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-2xl shadow-green-500/40 transition-all duration-500 group ${
