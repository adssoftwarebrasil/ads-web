        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-neutral-400 text-sm leading-relaxed mb-6">
              Especialistas em Saúde e Segurança Ocupacional em Araxá.
            </p>
            <a
              href="https://www.instagram.com/advicearaxa/"
              target="_blank"
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-neutral-400 text-sm">
                  R. Cap. Izidro, 365 - Centro, Araxá - MG
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-4 h-4 text-brand-400 mt-0.5 flex-shrink-0" />
                <span className="text-neutral-400 text-sm">(34) 3612-1011</span>
              </li>
              <li className="flex items-start gap-3">
      ...
      <div className="border-t border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-neutral-500 text-sm">
            © 2026 Advice Gestão em Saúde LTDA. Todos os direitos reservados.
          </p>
          <a
