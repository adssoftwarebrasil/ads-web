          ...
          {services.map((service, i) => (
            ...
            >
              <div className="w-14 h-14 bg-brand-50 rounded-xl flex items-center justify-center mb-5 group-hover:bg-brand-500 transition-colors duration-300">
                <service.icon className="w-7 h-7 text-brand-500 group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-1">{service.title}</h3>
              <p className="text-xs font-semibold text-brand-500 mb-3">{service.subtitle}</p>
