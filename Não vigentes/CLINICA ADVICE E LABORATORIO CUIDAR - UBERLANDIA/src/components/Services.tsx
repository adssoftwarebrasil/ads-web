      ...
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-neutral-500 max-w-2xl mx-auto">
            Portfólio completo em Medicina e Engenharia do Trabalho para manter
            sua empresa em conformidade e seus colaboradores protegidos.
          </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((service, index) => {
            ...
            return (
              <div
                key={service.title}
                className={`bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl border border-neutral-100 hover:border-brand-200 transition-all duration-500 group ${
                  isInView
                    ? 'opacity-100 translate-y-0'
                    : 'opacity-0 translate-y-8'
                }`}
              ...
              >
                ...
                <p className="text-xs font-semibold text-brand-500 mb-3">
                  {service.subtitle}
                </p>
