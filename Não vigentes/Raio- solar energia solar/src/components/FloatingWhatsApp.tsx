  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 transition-all duration-500 opacity-100 translate-y-0">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-2xl hover:bg-[#20c05a] hover:scale-110 active:scale-95 transition-all duration-200"
      >
