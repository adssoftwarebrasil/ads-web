import { Sparkles, Search, TrendingUp, Code, CheckCircle2, ArrowRight } from 'lucide-react';
...
const services: Service[] = [
  {
    ...
    description:
      'Google Ads gerenciado por especialistas certificados. Posicionamento estratégico que coloca sua empresa no topo das pesquisas.',
    features: ['Campanhas otimizadas', 'ROI comprovado', 'Análise contínua', 'Relatórios detalhados'],
    bar: 'from-[#4286f5] to-[#1264C6]',
    iconBg: 'from-[#4286f5] to-[#1264C6]',
    hoverBg: 'from-blue-50 to-blue-100/50',
    btn: 'from-[#4286f5] to-[#1264C6]',
    popular: true,
  },
  {
    Icon: TrendingUp,
    ...
    description:
      'Estratégias personalizadas para cada negócio. Gestão profissional de campanhas em Meta Ads com foco em resultados.',
    features: ['Segmentação precisa', 'Conversões otimizadas', 'Acompanhamento 24/7'],
    bar: 'from-[#ea4235] to-[#f9bb04]',
    iconBg: 'from-[#ea4235] to-[#f9bb04]',
    hoverBg: 'from-red-50 to-orange-100/50',
    btn: 'from-[#ea4235] to-[#f9bb04]',
  },
  {
    Icon: Code,
    title: 'Desenvolvimento de Software',
    description:
      'Soluções tecnológicas personalizadas para seu negócio. Desenvolvimento com as melhores práticas e tecnologias do mercado.',
    features: ['Soluções sob medida', 'Tecnologia de ponta', 'Integração completa', 'Suporte especializado'],
    bar: 'from-[#33a753] to-[#1264C6]',
    iconBg: 'from-[#33a753] to-[#1264C6]',
    hoverBg: 'from-green-50 to-blue-100/50',
    btn: 'from-[#33a753] to-[#1264C6]',
  },
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {services.map((s) => (
            ...
            >
              ...
              <div className={`h-2 bg-gradient-to-r ${s.bar}`}></div>
              <div className={`absolute inset-0 bg-gradient-to-br ${s.hoverBg} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              <div className="relative p-8">
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${s.iconBg} mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}>
                ...
                <button className={`w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-gradient-to-r ${s.btn} text-white font-semibold hover:shadow-lg transition-all duration-300 group/btn`}>
                  Saiba Mais
