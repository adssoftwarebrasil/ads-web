          ...
          <div className="text-center lg:text-left">
            <div className="mb-6 flex flex-wrap gap-4 justify-center lg:justify-start">
              <img
                ...
                alt="Parceiro oficial Google Ads"
                loading="eager"
                width="1000"
                height="500"
                srcSet="https://storage-admin.lucasmendes.dev/api/v1/buckets/site-sp/objects/download?preview=true&prefix=ads-marketing%2F000103.png&version_id=null 1x"
                className="h-16 sm:h-20 lg:h-24 w-auto object-contain bg-white/95 rounded-xl px-6 py-3 shadow-lg"
              />
            </div>
            ...
            <p className="text-base sm:text-lg mb-10 text-gray-200 max-w-2xl mx-auto lg:mx-0 drop-shadow-md">
              8 anos transformando negócios através de estratégias comprovadas em Google Ads e Meta Business. Parceiros oficiais com resultados reais.
            </p>
