import { Trophy, Shield, CheckCircle2, Headphones, Rocket, Users, type LucideIcon } from 'lucide-react';
...
const reasons: Reason[] = [
  {
    ...
    desc: 'Experiência consolidada com milhares de campanhas bem-sucedidas em diversos segmentos do mercado.',
  },
  {
    Icon: Shield,
    title: 'Maior da América Latina',
    desc: 'Liderança reconhecida em impulsionamento digital, com presença forte em todo o continente.',
  },
  {
    Icon: CheckCircle2,
    title: 'Parceiros Oficiais',
    desc: 'Certificação Google Ads garantem acesso a recursos exclusivos.',
  },
  {
    Icon: Headphones,
    title: 'Atendimento Personalizado',
    desc: 'Equipe dedicada para entender suas necessidades e criar estratégias sob medida.',
  },
  {
    Icon: Rocket,
    title: 'Resultados Comprovados',
    desc: 'ROI mensurável com métricas transparentes e relatórios detalhados de performance.',
  },
  {
    Icon: Users,
    title: 'Suporte Especializado',
    desc: 'Time de especialistas disponível para garantir o sucesso contínuo das suas campanhas.',
  },
];
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#19355E] mb-4">Por Que Escolher a ADS Software?</h2>
