...
const HERO_BG =
  'https://storage.lucasmendes.dev/site-sp/advice%20uberlandia%2Fimg%2Fhero-background.webp';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 w-full">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            Cuidamos de quem cuida da{' '}
            <span className="text-brand-400">sua empresa</span>
          </h1>

          <p className="text-lg sm:text-xl text-white/80 leading-relaxed mb-10 max-w-xl">
            Referência em Medicina e Engenharia do Trabalho há mais de 34 anos
            em Uberlândia. Estrutura completa, laboratório
            próprio e atendimento humanizado.
          </p>
