...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-black/10 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {navItems.map((item) => (
              <button
                ...
                className="text-sm font-medium transition-colors duration-200 hover:text-brand-500 text-white"
              >
                {item.label}
              </button>
            ))}
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a
              href="tel:+553436121011"
              className="flex items-center gap-2 text-sm font-medium transition-colors text-white/90"
            >
