...
const items: StructureItem[] = [
  {
    img: 'https://storage.lucasmendes.dev/site-sp/advice%20araxa%2Fimg%2Fcadeiras-verdes-sala-espera.webp',
    alt: 'Sala de Espera',
    label: 'Sala de Espera',
  },
  {
    img: 'https://storage.lucasmendes.dev/site-sp/advice%20araxa%2Fimg%2Frecepcao-clinica-moderna.webp',
    alt: 'Recepção',
    label: 'Recepção',
  },
  {
    img: 'https://storage.lucasmendes.dev/site-sp/advice%20araxa%2Fimg%2Fescritorio-cabine-audicao.webp',
    alt: 'Consultório',
    label: 'Consultório de Audiência',
  },
  {
    img: 'https://storage.lucasmendes.dev/site-sp/advice%20araxa%2Fimg%2Fsala-consulta-medica.webp',
    alt: 'Sala de Consulta',
    label: 'Sala de Consulta Médica',
  },
  {
    img: 'https://storage.lucasmendes.dev/site-sp/advice%20araxa%2Fimg%2Fpoltrona-bege-consultorio.webp',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {items.map((item, i) => (
            <div
              key={i}
              className="group relative overflow-hidden rounded-2xl aspect-[4/3] w-[calc(50%-8px)] lg:w-[calc(25%-12px)] transition-all duration-700 opacity-100 scale-100"
