export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/5531986801584?text=Olá!%20Gostaria%20de%20solicitar%20um%20orçamento."
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 md:bottom-6 md:right-6 z-50 w-16 h-16 bg-[rgb(37,211,102)] rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center group animate-pulse hover:animate-none"
