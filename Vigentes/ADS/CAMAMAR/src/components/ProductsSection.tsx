    ...
    subcategories: [
      {
        ...
        products: [
          ...
          mk(parafusoProduct, "CAM-305", "Parafuso Autoperfurante", "Os parafusos autoperfurantes possuem revestimento Ecoseal, garantindo maior durabilidade para a obra, além de contarem com ponta broca Super Bit para alta velocidade de furação e design exclusivo que proporciona vedação eficiente da cobertura.\n\nO parafuso ideal para coberturas em policarbonato depende da estrutura de apoio.\n\n• Para estruturas de aço, recomenda-se o PB 12-14x1.1/4 ou PB 12-14x1.1/2 com ponta broca.\n\n• Para estruturas de madeira (pergolados), recomenda-se o Woodtite 4,8x38 com ponta agulha.", ["Rápida instalação: A ponta broca superbit proporciona a instalação do parafuso 4x mais rápida que outros do mercado.", "Cobertura sem goteiras: Cabeça flangeada com design DUH aloja perfeitamente a arruela EPDM e absorve até 10° de inclinação sem risco de vazamento.", "Alta durabilidade: Exclusivo revestimento Ecoseal® em toda a superfície do fixador, garantindo maior durabilidade para a sua obra. Este revestimento é aplicado em 6 etapas, aumenta a longevidade e atua como isolante, garantindo assim alta resistência à corrosão e a intempéries."]),
