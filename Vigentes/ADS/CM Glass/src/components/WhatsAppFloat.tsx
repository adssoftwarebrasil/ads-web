export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#1ebe57] rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-500 group opacity-100 scale-100 translate-y-0"
    >
      <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-30"></span>
      <svg
        viewBox="0 0 24 24"
        className="w-7 h-7 fill-white relative z-10 group-hover:scale-110 transition-transform duration-200"
      >
