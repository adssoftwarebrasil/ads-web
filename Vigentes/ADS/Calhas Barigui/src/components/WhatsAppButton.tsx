...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] text-white shadow-xl shadow-[#25D366]/30 rounded-full px-5 py-3.5 hover:bg-[#20bd5b] transition-all duration-300 hover:shadow-2xl hover:shadow-[#25D366]/40 hover:-translate-y-1 group"
    >
