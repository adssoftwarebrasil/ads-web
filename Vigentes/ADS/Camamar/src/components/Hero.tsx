  ...
  return (
    <section id="inicio" className="relative">
      <div className="relative h-screen min-h-[640px] w-full overflow-hidden">
        <div className="absolute inset-0 will-change-transform" style={{ transform: 'translate3d(0px, 0px, 0px)' }}>
          <img
            src="/assets/hero-construction-KBWd6kfV.jpg"
            alt="Obra Camamar"
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-black/85 via-black/55 to-black/40"></div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 w-full">
            <div className="max-w-2xl">
              ...
              <p className="animate-hero-subtitle text-white/90 text-lg md:text-xl max-w-xl mb-10 leading-relaxed text-shadow-hero">
                Fundada em 1995, a <strong className="font-bold text-white">CAMAMAR</strong> oferece materiais de alta
                performance e atendimento especializado para obras mais seguras, duráveis e eficientes.
              </p>
              <div className="animate-hero-cta flex flex-wrap gap-4">
                ...
                >
                  <WhatsAppIcon className="group-hover:rotate-12 transition-transform" height={24} width={24} />
                  Fale pelo WhatsApp
                </a>
                <a
                  href="#produtos"
          ...
          {features.map(({ Icon, title, desc }) => (
            <div key={title} className="flex items-center gap-4 px-6 py-6">
              <div className="w-14 h-14 rounded-full bg-primary/15 border border-primary/40 flex items-center justify-center shrink-0">
                <Icon className="w-7 h-7 text-primary" width={24} height={24} strokeWidth={2} />
              </div>
              <div>
