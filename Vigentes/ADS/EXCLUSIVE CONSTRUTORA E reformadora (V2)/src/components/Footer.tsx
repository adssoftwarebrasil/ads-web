...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-[#050a1e] to-[#000000]">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="bg-[#0a154b] p-3 rounded-lg text-[#07dde5] hover:bg-[#07dde5] hover:text-[#050a1e] transition-all duration-300 transform hover:scale-110"
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a
                  href="mailto:contato@exclusiveconstrutora.com"
                ...
                >
                  ...
                  <span className="break-all">contato@exclusiveconstrutora.com</span>
                </a>
              </li>
              <li className="flex items-start gap-3 text-gray-400 text-sm group">
