...
export const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-[#0a154b] z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <button onClick={() => scrollToSection('diferenciais')} className="text-white hover:text-[#07dde5] transition-colors">
              Diferenciais
            </button>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#0a154b] border-t border-[#104071]">
          <nav className="flex flex-col px-4 py-4 gap-4">
            ...
            <button onClick={() => scrollToSection('diferenciais')} className="text-white hover:text-[#07dde5] text-left py-2">
              Diferenciais
            </button>
