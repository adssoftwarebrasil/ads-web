    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="text-4xl font-bold text-[#050a1e] mb-4">
            Nossos Serviços
          </h2>
            ...
            return (
              ...
              >
                <div className="flex justify-center mb-4 md:mb-6">
                  <div className="p-3 md:p-4 bg-[#050a1e] rounded-full">
                    <Icon className="text-[#07dde5]" size={28} />
                  </div>
                </div>
                <h3 className="text-lg md:text-xl font-bold text-[#050a1e] mb-2 md:mb-3 text-center">
                  {service.title}
                </h3>
