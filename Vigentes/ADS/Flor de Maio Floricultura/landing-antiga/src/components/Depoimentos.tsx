        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {depoimentos.map((d) => (
            ...
            >
              ...
              <p className="text-[var(--texto-medio)] text-lg leading-relaxed mb-6">{d.text}</p>
              <div className="border-t border-gray-300 pt-4">
                <p className="font-bold text-[var(--texto-escuro)]">{d.name}</p>
                <p className="text-[var(--texto-medio)] text-sm">{d.location}</p>
              </div>
            </div>
          ))}
        </div>
