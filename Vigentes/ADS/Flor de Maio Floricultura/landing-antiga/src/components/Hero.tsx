...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-[85vh] sm:min-h-[90vh] lg:min-h-screen flex items-center justify-center text-white overflow-hidden"
    >
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage:
            'url("https://storage.lucasmendes.dev/site-sp/giovannaflores%2Fhero2.webp")',
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="text-center space-y-6 sm:space-y-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.1] animate-fade-in-up">
            39 Anos Encantando São Luís
            <br className="hidden sm:block" /> com Flores Naturais
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed max-w-3xl mx-auto opacity-95">
            A floricultura mais tradicional de São Luís. Entrega rápida no mesmo dia, de domingo a
            domingo.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center pt-4">
            ...
            >
              <ShoppingBag className="lucide lucide-shopping-bag w-5 h-5 group-hover:scale-110 transition-transform" />
            ...
            >
              <MessageCircle className="lucide lucide-message-circle w-5 h-5 group-hover:scale-110 transition-transform" />
          ...
          <div className="inline-flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 lg:gap-6 bg-white/95 backdrop-blur-sm text-[#1a1a1a] px-5 sm:px-6 lg:px-8 py-3 sm:py-3.5 lg:py-4 rounded-xl sm:rounded-2xl text-xs sm:text-sm lg:text-base font-medium shadow-lg">
            <div className="flex items-center gap-3 sm:gap-6">
              <span className="flex items-center gap-1.5">
                <span className="text-[rgb(254,0,0)] font-bold">✓</span>Desde 1986
              </span>
              <span className="hidden sm:inline text-gray-300">|</span>
              <span className="flex items-center gap-1.5">
                <span className="text-[rgb(254,0,0)] font-bold">✓</span>Entrega no Mesmo Dia
              </span>
            </div>
            <div className="flex items-center">
              <span className="hidden sm:inline text-gray-300 mr-3 lg:mr-6">|</span>
              <span className="flex items-center gap-1.5">
                <span className="text-[rgb(254,0,0)] font-bold">✓</span>Aberto Domingo
              </span>
            </div>
          </div>
        </div>
