...
const horarios = [
  ...
  { dia: 'Sábado', hora: '7h às 20h' },
  { dia: 'Domingo', hora: '8h às 13h' },
];
    ...
    <footer className="bg-[#1a1a1a] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                <Phone className="lucide lucide-phone w-5 h-5 mt-0.5 flex-shrink-0" />
                <span>(98) 98307-8865</span>
              </a>
              <a
                href="https://wa.me/5598986908178"
                className="flex items-start gap-3 text-gray-400 hover:text-white transition-colors"
              >
                <Phone className="lucide lucide-phone w-5 h-5 mt-0.5 flex-shrink-0" />
              ...
              <a
                ...
                className="flex items-start gap-3 text-gray-400 hover:text-white transition-colors"
              >
                <Mail className="lucide lucide-mail w-5 h-5 mt-0.5 flex-shrink-0" />
            ...
            <div className="space-y-3 text-gray-400">
              {horarios.map((h) => (
                <div key={h.dia} className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-white">{h.dia}</p>
                    <p>{h.hora}</p>
                  </div>
                </div>
              ))}
      ...
      <div className="bg-[#0f0f0f] py-6 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center text-gray-400 text-sm">
          <p>
            © 2025 Flor de Maio Floricultura. Todos os direitos reservados. CNPJ:
            38.077.453/0001-99
          </p>
        </div>
      </div>
