const testimonials = [
  ...
  {
    quote:
      '"Excelente atendimento! A equipe é atenciosa e resolve tudo com agilidade. Recomendo para qualquer empreendedor no DF."',
    name: 'Ana Carolina',
...
function Star() {
  return (
    <svg className="w-5 h-5" viewBox="0 0 20 20" style={{ fill: 'rgb(192, 160, 98)' }}>
