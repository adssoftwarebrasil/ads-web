...
const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Orientação estratégica para o crescimento sustentável do seu negócio.',
  },
  {
    Icon: Building2,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Soluções contábeis completas para impulsionar seu negócio
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map(({ Icon, iconClass, title, description }) => (
            ...
            >
              ...
              >
                Saiba Mais
                <ArrowRight size={18} className="lucide lucide-arrow-right ml-2" />
              </button>
            </div>
          ))}
        </div>
