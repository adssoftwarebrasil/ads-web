...
const reasons: Reason[] = [
  {
    ...
    description: (
      <>
        Mais do que prestadores de serviço, somos parceiros estratégicos dos nossos clientes,
        oferecendo suporte contínuo e orientações que ajudam na tomada de decisões&nbsp;seguras.
      </>
    ),
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Por que Escolher a Gerencial Contábil?
          </h2>
        </div>
