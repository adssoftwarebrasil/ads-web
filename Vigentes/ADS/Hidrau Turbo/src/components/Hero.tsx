    ...
    <section id="inicio">
      <div className="relative h-[calc(100vh-80px)] min-h-[600px] flex items-center justify-center overflow-hidden group">
        <div
          ...
          style={{
            backgroundImage:
              'url("https://storage.lucasmendes.dev/site-sp/hidrau%20turbo%2Fimg%2Fhero-background-paralax.webp")',
          }}
        ></div>
        ...
        <div className="relative z-10 w-full max-w-[1280px] px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          >
            <CheckCircle2 size={16} className="lucide lucide-check-circle2 text-accent-red" />
            <span>Qualidade Garantida Bosch</span>
          </div>
          <h1
          ...
          >
            Oficina Mecânica Premium e Distribuidora Autorizada
          </h2>
          <p
            className="text-base sm:text-lg text-gray-300/90 leading-relaxed max-w-[600px] mb-10 animate-fade-in-up opacity-0"
            style={{ animationDelay: '300ms' }}
          >
            Soluções completas com peças originais Bosch para garantir a máxima performance e
          ...
          >
            ...
            <MessageCircle size={24} className="lucide lucide-message-circle relative" />
