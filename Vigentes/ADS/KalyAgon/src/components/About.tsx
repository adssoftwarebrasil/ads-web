  ...
  const timeline = [
    {
      period: 'Início',
      year: '1992',
      description: 'Fundada em 22 de fevereiro de 1992, a Kaly Agon nasceu de uma necessidade de mercado. Desde o início, o compromisso com a qualidade e honestidade guiam todas as nossas decisões, criando uniformes escolares e profissionais que valorizam seus clientes.',
    },
    {
      period: 'Hoje',
      year: '2025',
      description: 'Após 33 anos no mercado, continuamos ofrecendo confecção de uniformes personalizados com bordado, silkscreen, sublimação e DTF. Nosso diferencial é o atendimento personalizado com cada cliente, garantindo prazos de entrega e qualidade incomparáveis.',
    },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            33 anos de dedicação à excelência em uniformes personalizados
          </p>
        </div>
          ...
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-white px-8 py-6 rounded-2xl shadow-xl border border-gray-100">
            <div className="text-center sm:text-left">
              ...
              <p className="text-gray-600 text-sm">
                Junte-se às empresas que confiam na Kaly Agon
              </p>
            </div>
            <button
              onClick={() => window.open('https://wa.me/5561996122686?text=Olá!%20Gostaria%20de%20conhecer%20mais%20sobre%20os%20uniformes%20personalizados.', '_blank')}
