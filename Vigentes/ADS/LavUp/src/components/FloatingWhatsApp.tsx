...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-end gap-3 transition-all duration-500 opacity-100 translate-y-0">
      {showTooltip && (
        <div className="relative mb-2 animate-fade-in">
          <div className="bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-2 max-w-[200px] border border-gray-100">
          ...
          <div className="absolute right-[-6px] bottom-4 w-3 h-3 bg-white border-t border-r border-gray-100 rotate-45"></div>
        </div>
      )}
      <a
        href={WHATSAPP}
