import { Target, Award, Users, TrendingUp, ArrowRight } from 'lucide-react';
...
const features = [
  {
    title: 'Missão',
    text: 'Desenvolvimento sustentável do agronegócio',
    icon: Target,
  ...
  {
    title: 'Qualidade',
    text: 'Peças e implementos de alta performance',
    icon: Award,
    iconClass: 'lucide lucide-award text-white',
    bg: 'bg-gradient-to-br from-[#F8D617] to-[#e6c615]',
  },
  {
    title: 'Equipe',
    text: 'Profissionais especializados e dedicados',
    icon: Users,
    iconClass: 'lucide lucide-users text-white',
    bg: 'bg-gradient-to-br from-[#001F7A] to-[#1A385C]',
  },
  {
    title: 'Inovação',
    text: 'Soluções modernas para o campo',
    icon: TrendingUp,
    iconClass: 'lucide lucide-trending-up text-white',
    bg: 'bg-gradient-to-br from-[#1A385C] to-[#001F7A]',
  },
];
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 md:space-y-5 text-[#424242] text-base md:text-lg leading-relaxed">
              <p>
                ...
                setor agrícola em{' '}
                <strong className="text-[#1A385C]">Dourados e região</strong>. Com
                uma equipe especializada e um portfólio diversificado, somos
                dedicados a oferecer peças e implementos de alta qualidade, visando
                a eficiência no trabalho do produtor rural.
              </p>
              <p>
                Nossa missão é{' '}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {features.map((f) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 md:w-14 md:h-14 ${f.bg} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
