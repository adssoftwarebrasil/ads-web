      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 animate-fade-in-up animation-delay-400 mb-8 md:mb-12">
            ...
            >
              <Store className="lucide lucide-store sm:w-6 sm:h-6 group-hover:rotate-12 transition-transform duration-300 flex-shrink-0" width={20} height={20} />
              <span className="whitespace-nowrap">NOSSAS LOJAS</span>
              <ArrowRight className="lucide lucide-arrow-right sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform duration-300 flex-shrink-0" width={18} height={18} />
            </a>
            <a
              href={WHATSAPP_URL}
              target="_blank"
            ...
            >
              <Settings className="lucide lucide-settings sm:w-6 sm:h-6 group-hover:rotate-90 transition-transform duration-500 flex-shrink-0" width={20} height={20} />
