export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-2xl bg-[#25D366] hover:bg-[#1ebe5d] transition-all duration-300 hover:scale-110 hover:shadow-[#25D366]/40"
    >
