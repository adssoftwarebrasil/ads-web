...
import { WHATSAPP_URL, PHONE_TEL, EMAIL, scrollToSection } from '../lib/constants';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-2.5">
            <div className="flex items-center gap-4 md:gap-6 text-white text-xs sm:text-sm">
              ...
              >
                <Phone className="lucide lucide-phone group-hover:rotate-12 transition-transform" width={16} height={16} />
                <span className="hidden sm:inline">(67) 99292-0122</span>
              </a>
              <a
                href={`mailto:${EMAIL}`}
                className="hidden md:flex items-center gap-2 hover:text-[#F8D617] transition-colors group"
              >
                <Mail className="lucide lucide-mail group-hover:scale-110 transition-transform" width={16} height={16} />
                <span>{EMAIL}</span>
              </a>
            </div>
