      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative max-w-6xl mx-auto">
                ...
                <div key={t.initials} className="w-full flex-shrink-0 px-2 md:px-4">
                  <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 p-8 md:p-12 relative border border-gray-100 group">
                    <div className="absolute -top-4 -left-4 w-20 h-20 bg-[#F8D617] rounded-2xl flex items-center justify-center shadow-lg rotate-6 group-hover:rotate-12 transition-transform duration-300">
                      <Quote className="lucide lucide-quote text-[#1A385C]" width={40} height={40} strokeWidth={2.5} />
                    </div>
          ...
          <button
            ...
            aria-label="Anterior"
          >
            <ChevronLeft className="lucide lucide-chevron-left group-hover:-translate-x-0.5 transition-transform" width={28} height={28} />
          </button>
          <button
            onClick={next}
            ...
            aria-label="Próximo"
          >
            <ChevronRight className="lucide lucide-chevron-right group-hover:translate-x-0.5 transition-transform" width={28} height={28} />
          </button>
        ...
        <div className="text-center mt-16">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#4CAF50] text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#2E7D32] transition-all duration-300 hover:shadow-xl hover:scale-105"
          >
