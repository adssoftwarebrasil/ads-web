  ...
  const features = [
    {
      ...
      description: 'Próximo a cafeterias, restaurantes, farmácias, universidade e posto de combustível'
    },
    {
      icon: Wifi,
      title: 'Wi-Fi Gratuito',
      description: 'Internet de alta velocidade em todas as dependências do hotel'
    },
    {
      icon: Clock,
      title: 'Serviço 24 Horas',
      description: 'Recepção e atendimento disponíveis o dia todo, todos os dias'
    },
    {
      icon: Car,
      title: 'Garagem Exclusiva',
      description: 'Estacionamento próprio e privativo para hóspedes'
    },
    {
      icon: Coffee,
      title: 'Café da Manhã',
      description: 'Buffet completo e variado servido todas as manhãs'
    },
    {
      icon: Shield,
      title: 'Segurança Total',
      description: 'Câmeras em todas as áreas comuns para sua tranquilidade'
    }
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Estrutura completa para acomodar bem nossos hóspedes em Altamira
          </p>
        </div>
