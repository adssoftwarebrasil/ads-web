...
export default function WhatsAppFloat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 transition-all duration-500 opacity-100 translate-y-0">
      {showBubble && (
        <div className="relative bg-white rounded-2xl shadow-2xl px-4 py-3 max-w-[200px] border border-gray-100 animate-fade-in">
          <button
            ...
            aria-label="Fechar"
          >
            <X className="text-white" width={10} height={10} />
          </button>
          <p className="text-gray-700 text-xs font-medium leading-tight">
            Olá! Faça seu pedido agora pelo WhatsApp!
          </p>
      ...
      <a
        ...
        className="group relative w-16 h-16 bg-[#25D366] hover:bg-[#1da851] rounded-full flex items-center justify-center shadow-2xl shadow-green-600/40 transition-all duration-300 hover:scale-110 hover:shadow-green-600/60"
      >
