      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="flex-shrink-0 flex items-center py-3">
            ...
            >
              <div className={`bg-blue-700 rounded-lg px-3 flex items-center justify-center transition-all duration-300 ${isScrolled ? 'py-1.5' : 'py-2'}`}>
                <img
      ...
      >
        <div className="px-4 py-6 space-y-4 shadow-inner">
          ...
          <div className="pt-4 px-4">
            <button
              onClick={() => {
                window.open('https://wa.me/5593991462057?text=Olá! Gostaria de fazer uma reserva.', '_blank');
                setIsMobileMenuOpen(false);
              }}
