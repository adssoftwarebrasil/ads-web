export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-400 rounded-full flex items-center justify-center shadow-2xl shadow-green-600/40 transition-all duration-500 hover:scale-110 active:scale-95 opacity-100 translate-y-0"
    >
