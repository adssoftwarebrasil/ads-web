...
import { imageOrPlaceholder } from '../lib/placeholder';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
        <div className="lg:col-span-5 relative">
          <div className="relative rounded-[2rem] overflow-hidden shadow-ring aspect-[4/5]">
            <img
              src={imageOrPlaceholder(site.sobre.imagem, `${site.empresa.nome} sobre`)}
        ...
        <div className="lg:col-span-7">
          ...
          {site.sobre.diferenciais.length > 0 && (
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {site.sobre.diferenciais.map((dif, i) => {
                const Icon = getIcon(dif.icone);
                return (
                  <li key={i} className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-secondary text-sm leading-relaxed">{dif.descricao}</p>
                    </div>
                  </li>
                );
              })}
