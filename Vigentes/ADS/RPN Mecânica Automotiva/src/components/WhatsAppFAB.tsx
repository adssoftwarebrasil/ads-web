  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <a
          href="http://wa.me/559182696336?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20agendar%20um%20serviço."
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Falar no WhatsApp"
          className="relative flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl shadow-green-500/40 transition-all duration-300 hover:scale-110 active:scale-95 animate-float"
        >
          <svg
            width="28"
            height="28"
