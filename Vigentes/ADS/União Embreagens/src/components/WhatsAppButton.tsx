export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 md:bottom-6 md:right-6 bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-2xl hover:bg-[#20BA5A] transition-all transform hover:scale-110 z-50 group"
