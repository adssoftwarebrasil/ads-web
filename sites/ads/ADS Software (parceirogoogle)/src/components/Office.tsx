...
const infos = [
  { Icon: MapPin, title: 'Endereço', lines: ['Av. C-4, 931 - Jardim América', 'Goiânia - GO, CEP 74265-040'] },
  { Icon: Clock, title: 'Horário de Atendimento', lines: ['Segunda a Sexta: 9h às 18h', 'Sábado: 9h às 13h'] },
  { Icon: Phone, title: 'Telefone', lines: ['0800 780 0040'] },
  { Icon: Mail, title: 'Email', lines: ['contato@adssoftware.com.br'] },
];
              ...
              <div className="space-y-6">
                {infos.map(({ Icon, title, lines }) => (
                  <div key={title} className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-[#19355E] mb-1">{title}</h4>
                  ...
                  {officeImages.map((_, i) => (
                    <button
                      ...
                      className={`transition-all duration-300 rounded-full ${
                        i === index ? 'bg-white w-8 h-3' : 'bg-white/50 hover:bg-white/75 w-3 h-3'
                      }`}
