...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      {tooltip && (
        <div className="relative flex items-center bg-white text-brand-dark text-sm font-semibold px-4 py-2.5 rounded-2xl shadow-xl border border-brand-light max-w-xs mr-1">
          <button
          ...
          {/* Arrow */}
          <span className="absolute -bottom-2 right-6 w-4 h-4 bg-white border-b border-r border-brand-light rotate-45" />
        </div>
      )}
      ...
      <a
        ...
        className="relative w-15 h-15 w-[60px] h-[60px] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all duration-200"
