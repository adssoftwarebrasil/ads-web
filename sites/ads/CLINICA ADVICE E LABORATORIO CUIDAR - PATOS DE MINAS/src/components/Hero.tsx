  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://storage.lucasmendes.dev/site-sp/advice%2Fimg%2Ffachada-predio-moderno-hero-background.webp"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 w-full">
        <div className="max-w-2xl">
          ...
          <p className="text-lg sm:text-xl text-white/80 leading-relaxed mb-10 max-w-xl">
            Referência em Medicina e Engenharia do Trabalho há mais de 34 anos em Patos de Minas e Alto
            Paranaíba. Estrutura completa, laboratório próprio e atendimento humanizado.
          </p>
