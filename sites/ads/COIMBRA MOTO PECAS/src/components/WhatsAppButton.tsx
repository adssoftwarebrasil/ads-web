...
export default function WhatsAppButton() {
  ...
  return (
    <a
      href="http://wa.me/559591557077?text=Olá! Gostaria de mais informações sobre produtos e serviços."
      target="_blank"
    ...
    >
      <div className="relative">
        ...
        <div className="relative bg-[#25D366] rounded-full p-4 shadow-2xl hover:scale-110 transition-transform duration-300">
          <svg
            viewBox="0 0 24 24"
      ...
      <div className="absolute right-full mr-4 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
        <div className="bg-gray-900 text-white px-4 py-2 rounded-lg shadow-xl">
          ...
          <p className="text-sm text-gray-300">Estamos online</p>
        </div>
      </div>
    </a>
  );
