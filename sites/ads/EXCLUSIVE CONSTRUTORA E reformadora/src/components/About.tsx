      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`grid md:grid-cols-2 gap-8 md:gap-12 items-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0a154b] mb-4 md:mb-6 leading-tight">
            ...
            <div className="bg-gradient-to-br from-[#0a154b] to-[#104071] p-5 md:p-6 rounded-2xl shadow-xl mb-5 md:mb-6">
            ...
            <div className="grid grid-cols-3 gap-3 md:gap-4">
              <div className="bg-white p-3 md:p-4 rounded-xl shadow-md hover:shadow-lg transition-all">
                ...
                <p className="text-xl md:text-2xl font-bold text-[#0a154b]">100%</p>
                <p className="text-xs text-gray-600">Satisfação</p>
              </div>
              <div className="bg-white p-3 md:p-4 rounded-xl shadow-md hover:shadow-lg transition-all">
                <Shield className="text-[#07dde5] mb-2" size={20} />
                <p className="text-xl md:text-2xl font-bold text-[#0a154b]">Garantia</p>
                <p className="text-xs text-gray-600">Total</p>
              </div>
              <div className="bg-white p-3 md:p-4 rounded-xl shadow-md hover:shadow-lg transition-all">
                <Zap className="text-[#07dde5] mb-2" size={20} />
                <p className="text-xl md:text-2xl font-bold text-[#0a154b]">Agilidade</p>
          ...
          <div className="relative px-6 md:px-0">
            ...
            <img
              src="https://storage-admin.lucasmendes.dev/api/v1/buckets/site-sp/objects/download?preview=true&prefix=exclusive-construtora%2Fexclusivefachada.webp&version_id=null"
              alt="Equipe de Engenheiros"
              className="relative rounded-2xl shadow-2xl w-full h-[400px] md:h-[500px] object-cover"
              loading="lazy"
            />
            <div className="absolute bottom-4 left-4 md:-bottom-6 md:-left-6 bg-gradient-to-br from-[#07dde5] to-[#04b8bf] text-[#0a154b] p-4 md:p-6 rounded-2xl shadow-2xl">
              <p className="text-3xl md:text-4xl font-bold">+12</p>
              <p className="text-xs md:text-sm font-semibold">Anos de Experiência</p>
            </div>
            <div className="absolute top-4 right-4 md:-top-6 md:-right-6 bg-gradient-to-br from-[#0a154b] to-[#104071] text-white px-4 py-2 md:px-5 md:py-3 rounded-2xl shadow-2xl">
