    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`grid md:grid-cols-2 gap-8 md:gap-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a154b] mb-4 md:mb-6">
            ...
            <div className="space-y-5 md:space-y-6">
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#0a154b] mb-1 text-sm md:text-base">Endereço</h3>
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#0a154b] mb-1 text-sm md:text-base">Horário de Atendimento</h3>
                  <p className="text-gray-700 text-sm md:text-base">
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#0a154b] mb-1 text-sm md:text-base">Telefone</h3>
                  <p className="text-gray-700 text-sm md:text-base">(62)99353-1722</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 md:p-8 rounded-lg shadow-xl">
            <h3 className="text-2xl font-bold text-[#0a154b] mb-6">
