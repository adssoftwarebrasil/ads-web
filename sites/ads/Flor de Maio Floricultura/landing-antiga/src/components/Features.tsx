      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((f) => (
            ...
            >
              <div className="text-5xl lg:text-6xl mb-4 text-[var(--vermelho)]">{f.icon}</div>
              <h3 className="text-xl font-bold mb-3 text-[var(--texto-escuro)]">{f.title}</h3>
              <p className="text-[var(--texto-medio)] leading-relaxed">{f.text}</p>
            </div>
          ))}
        </div>
      </div>
