      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-gray-900">Onde Nos Encontrar</h2>
            <div className="bg-gradient-to-r from-[#cfa165]/5 to-[#b88a4d]/5 p-6 rounded-xl border-l-4 border-[#cfa165]">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-sm text-gray-500 uppercase mb-2">Nosso Escritório</p>
            ...
            <div className="bg-gradient-to-r from-[#cfa165]/5 to-[#b88a4d]/5 p-6 rounded-xl">
              <div className="flex items-start gap-4">
                <Clock className="lucide lucide-clock w-6 h-6 text-[#cfa165] flex-shrink-0" />
                <div>
                  <p className="font-semibold text-sm text-gray-500 uppercase mb-2">Horário de Atendimento</p>
                  <p className="text-gray-700 text-lg">Segunda a Sexta: 8h às 17h</p>
                  <p className="text-sm text-gray-500 mt-2">Atendimento via WhatsApp 24/7</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-r from-[#cfa165]/5 to-[#b88a4d]/5 p-6 rounded-xl">
              <div className="flex items-start gap-4">
                <Globe className="lucide lucide-globe w-6 h-6 text-[#cfa165] flex-shrink-0" />
                <div>
                  <p className="font-semibold text-sm text-gray-500 uppercase mb-2">Onde Atuamos</p>
                  <p className="text-gray-700 text-lg">
                    Em todo o <span>Brasil</span>!
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <Calendar className="lucide lucide-calendar w-5 h-5" />
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative">
                ...
                <div className="relative bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl">
                  <MapPin className="lucide lucide-map-pin w-16 h-16 text-[#cfa165] mx-auto animate-bounce" />
                  <p className="text-center mt-4 font-bold text-gray-900">Em Todo o Brasil</p>
