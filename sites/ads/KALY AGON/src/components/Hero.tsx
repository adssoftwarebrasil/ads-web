          ...
          <div className="grid lg:grid-cols-2 items-end">
            ...
            <div className="order-1 lg:order-2 px-6 sm:px-10 lg:px-16 py-8 sm:py-12 lg:py-16 lg:pb-24">
              <h1 className="text-[36px] sm:text-[44px] lg:text-[54px] xl:text-[60px] leading-[1.15] font-bold text-[#012E60] mb-6">
                Uniformes Personalizados com{' '}
                <span className="text-[#D7B46A]">Qualidade e Compromisso</span>
              </h1>

              <p className="text-base sm:text-lg text-gray-800 leading-relaxed mb-8 max-w-lg">
                Desde 1992, criamos uniformes escolares, profissionais e personalizados com <span className="font-bold text-[#012E60]">bordado, silkscreen, sublimação e DTF</span> — reforçando a identidade da sua empresa com atendimento personalizado.
              </p>

              <button
                onClick={() => window.open('https://wa.me/5561996122686?text=Olá!%20Gostaria%20de%20solicitar%20um%20orçamento%20para%20uniformes%20personalizados.', '_blank')}
