...
const Products = () => {
  const products = [
    {
      ...
      image: 'https://storage-admin.lucasmendes.dev/api/v1/buckets/site-sp/objects/download?preview=true&prefix=Kaly%20Agon%2F1.jpeg&version_id=null',
    ...
    {
      name: 'Camisa Polo',
      image: 'https://storage-admin.lucasmendes.dev/api/v1/buckets/site-sp/objects/download?preview=true&prefix=Kaly%20Agon%2F2.jpeg&version_id=null',
      description: 'Versátil, com gola e botões, une elegância e praticidade',
    },
    {
      name: 'Camisete Social Feminina',
      image: 'https://storage-admin.lucasmendes.dev/api/v1/buckets/site-sp/objects/download?preview=true&prefix=Kaly%20Agon%2F3.jpeg&version_id=null',
      description: 'Modelagem adaptada, conforto e sofisticação feminina',
    },
    {
      name: 'Jaleco',
      image: 'https://storage-admin.lucasmendes.dev/api/v1/buckets/site-sp/objects/download?preview=true&prefix=Kaly%20Agon%2F4.jpeg&version_id=null',
  ...
  const handleProductClick = (productName: string) => {
    const message = `Olá!%20Tenho%20interesse%20em%20${encodeURIComponent(productName)}.`;
    window.open(`https://wa.me/5561996122686?text=${message}`, '_blank');
  };
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Uniformes personalizados com bordado, silkscreen, sublimação e DTF
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-[#012E60] to-[#024080] px-6 sm:px-12 py-8 rounded-2xl shadow-2xl max-w-3xl mx-auto">
            ...
            <button
              onClick={() => window.open('https://wa.me/5561996122686?text=Olá!%20Gostaria%20de%20um%20orçamento%20personalizado.', '_blank')}
