...
$.extend($.validator, {
	...
	messages: {
		...
		email: "Entre com um endere&ccedil;o de e-mail v&aacute;lido.",
		url: "Insira uma URL v&aacute;lida.",
		date: "Insira uma data v&aacute;lida.",
		dateISO: "Please enter a valid date (ISO).",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "Insira somente n&uacute;meros.",
...
jQuery.validator.addMethod("nomeRazao", function(value, element) {
	expReg = /^[a-zA-Z\. \u00C0-\u00ff]{3,}\s+[a-zA-Z\. \u00C0-\u00ff]{2,}/;
	return value.match(expReg);
}, " ");
jQuery.validator.addMethod("moedaReal", function(value, element) {
	var valorPadrao = "0,00";
	expReg = /^\$(\d{1,3}(\,\d{3})*|(\d+))(\.\d{2})?$/;
	if ((value == valorPadrao) || (value.match(expReg))) return false;
	return true;
}, " ");
...
$.validator.addMethod('telefone', function (telefone, element) {
	...
	return (this.optional(element) || ((telefone.length == 11 || telefone.length == 10) && parseInt(telefone.substring(0, 2)) > 10 && parseInt(telefone.substring(2, 3)) > 1));
...
$.validator.addMethod('celular', function (celular, element) {
	...
	return (this.optional(element) || ((celular.length == 11 || celular.length == 10) && parseInt(celular.substring(0, 2)) > 10 && parseInt(celular.substring(2, 3)) > 5));
}, 'Informe um telefone celular v&aacute;lido.');
$.validator.addMethod('fullname', function (value, element) {
	return this.optional(element) || /([àáãäèéëìíïòóõöùúüÀÁÃÄÈÉËÌÍÏÒÓÕÖÙÚÜçÇ&A-za-z]{2,})+ ([,.\s&]*([àáãäèéëìíïòóõöùúüÀÁÃÄÈÉËÌÍÏÒÓÕÖÙÚÜçÇ&A-za-z]{2,})+)+/g.test(value);
