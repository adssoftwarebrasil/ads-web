    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 transition-all duration-700 opacity-0 -translate-x-8">
          ...
          <div className="order-1 lg:order-2 transition-all duration-700 delay-200 opacity-0 translate-x-8">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-900 mb-4 leading-tight">
              17 Anos Levando Tecnologia para{' '}
            ...
            <p className="text-gray-600 mb-8 leading-relaxed text-sm sm:text-base">
              Especialistas em telefonia celular, informática, eletrodomésticos e móveis. Nossa
              missão é garantir transparência, parceria e suporte completo.
            </p>
            <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-8 p-4 sm:p-6 bg-white rounded-xl shadow-sm border border-gray-100">
              <div
                className="text-center transition-all duration-500 opacity-0 translate-y-4"
              ...
              >
                ...
                <p className="font-black text-lg sm:text-2xl text-gray-900">17</p>
                <p className="text-xs text-gray-600 font-medium">Anos no Mercado</p>
              </div>
              <div
                className="text-center transition-all duration-500 opacity-0 translate-y-4"
              ...
              >
                ...
                <p className="font-black text-lg sm:text-2xl text-gray-900">+10k</p>
                <p className="text-xs text-gray-600 font-medium">Clientes Satisfeitos</p>
              </div>
              <div
                className="text-center transition-all duration-500 opacity-0 translate-y-4"
              ...
              >
                ...
                <p className="font-black text-lg sm:text-2xl text-gray-900">15x</p>
                <p className="text-xs text-gray-600 font-medium">no cartão</p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {beneficios.map((b, i) => (
                <div
                  key={b}
                  className="flex items-start gap-2.5 transition-all duration-500 opacity-0 translate-y-4"
                ...
                >
                  ...
                  <span className="text-gray-700 text-xs sm:text-sm leading-snug">{b}</span>
                </div>
              ))}
            </div>
          </div>
        </div>
        <div className="mt-12 md:mt-16 text-center transition-all duration-700 delay-1000 opacity-0 translate-y-4">
